...
public class CCollider : MonoBehaviour {	// Converts a standard Unity collider to a FastPhysics one.  Note that non-centered/resized collider components are not supported.  (Collider component 'Center' must read 0,0,0 and size 1,1,1)
