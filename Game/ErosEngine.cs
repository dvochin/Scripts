...
//    [HideInInspector]	public const string ErosDll = "ZFEmbedWeb";			//#DEV26:!!! The filename of the ErosEngine C++ dll that performs physics simulation, clothing, soft bodies, fluid and interface to Blender
...
//	[DllImport(ErosDll)] public static extern int		Object_PropConnect(IntPtr hObject, int nPropOrdinal, string sName);
//	[DllImport(ErosDll)] public static extern int		Object_PropDestroy(IntPtr hObject, int nPropOrdinal);
//	[DllImport(ErosDll)] public static extern float		Object_Get(IntPtr hProp, int nPropOrdinal);
//	[DllImport(ErosDll)] public static extern float		Object_Set(IntPtr hProp, int nPropOrdinal, float nValue);
...
//	[DllImport(ErosDll)] public static extern bool		gBL_Init();
