...
public class CCamMagnet : MonoBehaviour {
	...
	void Start() {
		...
		if (CGame.INSTANCE._oCamTarget != null) {		//###WEAK ###OPT
			...
			_oBoneSpring.connectedBody = CGame.INSTANCE._oCamTarget.GetComponent<Rigidbody>();
		}
	...
	void Update() {			//###OPT: Can find a cheaper way?
        ...
        //###P: Revive?
		//if      (Input.GetKeyDown(KeyCode.Alpha1))	_oBoneSpring.spring = CGame.INSTANCE._oCamTarget.CamMagnetPull_Unselected;
		//else if (Input.GetKeyDown(KeyCode.Alpha2))	_oBoneSpring.spring = (_eCamMagnetType == ECamMagnetType.Pelvis)	? CGame.INSTANCE._oCamTarget.CamMagnetPull_Selected : CGame.INSTANCE._oCamTarget.CamMagnetPull_Unselected;
		//else if (Input.GetKeyDown(KeyCode.Alpha3)) 	_oBoneSpring.spring = (_eCamMagnetType == ECamMagnetType.Breasts)	? CGame.INSTANCE._oCamTarget.CamMagnetPull_Selected : CGame.INSTANCE._oCamTarget.CamMagnetPull_Unselected;
		//else if (Input.GetKeyDown(KeyCode.Alpha4)) 	_oBoneSpring.spring = (_eCamMagnetType == ECamMagnetType.Head)		? CGame.INSTANCE._oCamTarget.CamMagnetPull_Selected : CGame.INSTANCE._oCamTarget.CamMagnetPull_Unselected;
	}
}
